// c++ -o compute spectreNaPiombo.cpp ../../../lib/analyzer.cc `root-config --cflags --glibs`
...
int main() {
    ...
    //computeHisto ("piombo", "sodio_piombo_01cm", "1", 8192, 1225, 1300, false, false);
    //computeHisto ("piombo", "sodio_piombo_01cm", "1", 8192, 1225, 1300, false, true);


    // PICCO 2 SODIO PIOMBO 0.1 cm
    //computeHisto ("piombo", "sodio_piombo_01cm", "2", 8192, 3200, 3300, false, false);
    //computeHisto ("piombo", "sodio_piombo_01cm", "2", 8192, 3200, 3300, false, true);
    ...
    //computeHisto ("piombo", "sodio_piombo_021cm", "2", 8192, 3200, 3300, false, false);
    //computeHisto ("piombo", "sodio_piombo_021cm", "2", 8192, 3200, 3300, false, true);
    ...
    //computeHisto ("piombo", "sodio_piombo_033cm", "1", 8192, 1225, 1300, false, false);
    //computeHisto ("piombo", "sodio_piombo_033cm", "1", 8192, 1225, 1300, false, true);


    // PICCO 2 SODIO PIOMBO 0.33 cm
    //computeHisto ("piombo", "sodio_piombo_033cm", "2", 8192, 3200, 3300, false, false);
    //computeHisto ("piombo", "sodio_piombo_033cm", "2", 8192, 3200, 3300, false, true);
    ...
    //computeHisto ("piombo", "sodio_piombo_058cm", "1", 8192, 1225, 1300, false, false);
    //computeHisto ("piombo", "sodio_piombo_058cm", "1", 8192, 1225, 1300, false, true);


    // PICCO 2 SODIO PIOMBO 0.58 cm
    //computeHisto ("piombo", "sodio_piombo_058cm", "2", 8192, 3200, 3300, false, false);
    //computeHisto ("piombo", "sodio_piombo_058cm", "2", 8192, 3200, 3300, false, true);
    ...
    //computeHisto ("piombo", "sodio_piombo_108cm", "1", 8192, 1225, 1300, false, false);
    //computeHisto ("piombo", "sodio_piombo_108cm", "1", 8192, 1225, 1300, false, true);


    // PICCO 2 SODIO PIOMBO 1.08 cm
    //computeHisto ("piombo", "sodio_piombo_108cm", "2", 8192, 3200, 3300, false, false);
    //computeHisto ("piombo", "sodio_piombo_108cm", "2", 8192, 3200, 3300, false, true);
